            ...
            <div>
              ...
              <div className="space-y-4 mb-12">
                <div className="flex items-center gap-3">
                  <span className="bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-4 py-2 rounded-lg text-caption">{t('about.status.badges.beta.label')}</span>
                  <p className="text-body-lg text-gray-500 dark:text-gray-400">{t('about.status.badges.beta.description')}</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-4 py-2 rounded-lg text-caption">{t('about.status.badges.avatars.label')}</span>
                  <p className="text-body-lg text-gray-500 dark:text-gray-400">{t('about.status.badges.avatars.description')}</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-4 py-2 rounded-lg text-caption">{t('about.status.badges.format.label')}</span>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.collections.original.title')}</h3>
              <p className="text-body-lg text-gray-900 dark:text-gray-100 mb-3 font-semibold">
                {t('about.collections.original.name')}
              </p>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-4">
                {t('about.collections.original.description')}
              </p>
              <ul className="space-y-2 text-gray-500 dark:text-gray-400 mb-8 text-body">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.collections.community.title')}</h3>
              ...
              <h2 className="text-title mb-6 text-gray-900 dark:text-gray-100">{t('about.whyThisExists.title')}</h2>
              
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.whyThisExists.problem.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-6">
                {t('about.whyThisExists.problem.description')}
              </p>

              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.whyThisExists.solution.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-6">
                {t('about.whyThisExists.solution.description')}
              </p>

              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.whyThisExists.mission.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-12">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.updates.lateJanuary.title')}</h3>
              <ul className="space-y-3 text-gray-500 dark:text-gray-400 mb-8 text-body">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.updates.midJanuary.title')}</h3>
              <ul className="space-y-3 text-gray-500 dark:text-gray-400 mb-8 text-body">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.updates.march2025.title')}</h3>
              ...
              <h2 className="text-title mb-6 text-gray-900 dark:text-gray-100">{t('about.whatMakesUsDifferent.title')}</h2>
              <ul className="space-y-3 text-gray-500 dark:text-gray-400 mb-12 text-body">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.development.builtWithAI.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-8">
                {t('about.development.builtWithAI.description')}
              </p>

              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.development.tools.title')}</h3>
              
              <h4 className="text-lg md:text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">{t('about.development.tools.initialBuild.title')}</h4>
              <ul className="space-y-2 text-gray-500 dark:text-gray-400 mb-6 text-body">
              ...
              <h4 className="text-lg md:text-xl font-semibold mb-3 text-gray-900 dark:text-gray-100">{t('about.development.tools.recentUpgrades.title')}</h4>
              <ul className="space-y-2 text-gray-500 dark:text-gray-400 mb-8 text-body">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.development.whatThisProves.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-4">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.development.openSource.title')}</h3>
              <p className="text-body-lg text-gray-500 dark:text-gray-400 mb-3">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-lg mb-8 border border-gray-300 dark:border-gray-700">
                <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.getInvolved.submitCollection.title')}</h3>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-lg mb-8 border border-gray-300 dark:border-gray-700">
                <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.getInvolved.contributeCode.title')}</h3>
                <p className="text-body text-gray-500 dark:text-gray-400 mb-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-lg mb-12 border border-gray-300 dark:border-gray-700">
                <h3 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">{t('about.getInvolved.giveFeedback.title')}</h3>
                <p className="text-body text-gray-500 dark:text-gray-400 mb-4">
